...
/* Smart Battery */
/* Battery extension hooks (charge thresholds etc.).
 *
 * Notifies registered extensions when SBS batteries appear or disappear,
 * replaying already-present batteries to late registrants. Errors in one
 * extension unload only that extension, never the battery.
 */
